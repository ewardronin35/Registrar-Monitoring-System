...
.signup a:hover{
  text-decoration: underline;
   ...
   <body>
      <div class="container">
         <header>Register Registrar Form </header>
         @if(Session::has('successs'))
             <div class="alert alert-sucesss" role="alert">
                {{Session::get('successs')}}
             </div>
             @endif
             <form method="post" action="{{url('save-registrar')}}">  
             @csrf 
            <div class="input-field">
               <input type="number" required name="id" value="{{old('id')}}">
               @error('id')
            ...
            <div class="input-field">
               <input type="text" required name="firstname" value="{{old('firstname')}}">
         ...
         <div class="signup">
           Already Registered?  <a href="{{url('login-registrar')}}">Login now</a>
         </div>
      </div>
      <script>
